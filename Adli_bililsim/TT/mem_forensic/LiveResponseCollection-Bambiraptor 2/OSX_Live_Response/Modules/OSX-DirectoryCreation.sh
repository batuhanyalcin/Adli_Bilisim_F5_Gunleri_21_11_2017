...
printf "Command Run: mkdir -p $computername/LiveResponseData/CopiedFiles\n"
printf "Command Run: mkdir -p $computername/LiveResponseData/CopiedFiles\n" >> "$computername/$computername""_Processing_Details.txt"
mkdir -p $computername/LiveResponseData/CopiedFiles >> "$computername/$computername""_Processing_Details.txt" 2>&1
printf "\n\n" >> "$computername/$computername""_Processing_Details.txt"
